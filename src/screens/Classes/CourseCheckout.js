    ...
    return(
        <ScreenContainer COLOR={"#F4F7FC"}  statBrColor={"#F4F7FC"}  BrStyle={"dark-content"}>
            ...
            resizeMode="contain"
             ...
             style={{width:250,height:250, alignSelf:'center', margin:50}} 
             />


             <Text style={{fontFamily: 'Sansation_Bold',fontSize:17, alignSelf:'center', width:'50%', textAlign:'center', lineHeight:25}}>Mathematics for Computer Games Development</Text>
             ...
             <TouchableOpacity  onPress={ () =>{
                ...
                }} style={{alignItems:'center',justifyContent:'center',backgroundColor: '#3FB65F',flexDirection:'row',marginHorizontal:5,borderRadius:28,marginTop:65,paddingHorizontal:30,paddingVertical:15}}>
            ...
            resizeMode="contain"
             ...
             />
                        ...
                        <Text style={{color:'#FFFF',fontSize:18,fontWeight:'bold'}}>  Cart</Text>
                </TouchableOpacity>
